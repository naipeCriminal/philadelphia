...
class Designmodo_registration_form
{
    ...
    public function registration_form()
    {
        ...
        <form method="post" action="<?php echo esc_url($_SERVER['REQUEST_URI']); ?>">
            <div class="login-form">
                ...
                <div class="form-group">
                    <input name="reg_celular" type="text" class="form-control login-field"
                           value="<?php echo(isset($_POST['reg_celular']) ? $_POST['reg_celular'] : null); ?>"
                           placeholder="celular!!!!" id="reg-celular"/>
                    <label class="login-field-icon fui-new" for="reg-celular"></label>
                </div>
    ...
    function shortcode()
    {
	    ...
	    $this->celular = $_POST['reg_celular'];
